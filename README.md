<div align="center">
  ...
  <h1>GRetPOS Web App</h1>

  <p> GRetPOS is a Point of Sale (POS) application built using Laravel for the API, the Filament admin panel for the web application, and Flutter for the mobile application. </p>
...
<!-- ![GRetPOS Screenshot](./readme/Screenshot/product-detail.png) -->
...
We welcome contributions from the community! If you'd like to contribute to GRetPOS, please follow these steps:
